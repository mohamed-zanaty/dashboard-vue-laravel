        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white" style="background-image:url('./img/ssss.jpg')">
...
<script>
    export default {
        ...
        methods: {
            getPhoto(){
                let photo = (this.form.photo.length > 150) ? this.form.photo : "img/profile/"+ this.form.photo ;
                return photo;
            },
